...
Continue to [Platform](../6.%20Platform/index.md) when you can point at one rejected request in the log, in the counter, and by its absence in MLflow, without guessing which store to open.
