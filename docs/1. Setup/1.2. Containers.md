...
A tag like `python:3.13.14-slim-trixie` can be re-pushed to point at different bytes; a digest cannot. Pinning both keeps multi-arch builds reproducible even when upstream moves a tag.
