...
!!! abstract "In one glance"
    ...
    - **You will:** Tell the agent's five kinds of memory apart, watch runbook retrieval pick a document, and learn why a long conversation can fail or lose old rules.
