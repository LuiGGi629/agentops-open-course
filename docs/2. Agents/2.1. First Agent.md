...
- `*ACTION_TOOLS` — the two guarded writes `restart_service` and `resolve_incident`. The tools are [3.1. Tools](../3.%20Capabilities/3.1.%20Tools.md#which-read-tools-does-the-agent-expose); their approval flow is [4.5. Guardrails](../3.%20Capabilities/3.1.%20Tools.md#how-does-human-confirmation-work).
