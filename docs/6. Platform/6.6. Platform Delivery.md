...
!!! note "In one glance"
    ...
    One `skaffold dev -p local` builds, pushes, and deploys the whole stack; the rest of this page is the backup and restore drill you must rehearse before an incident, not during one.
