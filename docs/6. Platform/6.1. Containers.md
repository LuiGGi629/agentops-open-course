...
??? note "Deeper: verify a published release image yourself"
    ...
    cosign verify \
      ...
      --certificate-identity "https://github.com/MLOps-Courses/agentops-open-course/.github/workflows/release.yml@refs/tags/v0.2.0" \
      ghcr.io/mlops-courses/agentops-open-course/agent:v0.2.0
