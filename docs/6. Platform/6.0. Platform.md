...
The diagram's **[state PVC](../0.%20Overview/0.7.%20Glossary.md#pvc)** uses the [RWO](../0.%20Overview/0.7.%20Glossary.md#rwo) access mode so one node mounts it for writing at a time.
