...
Return to [8. Community](./index.md) and pick your next maintenance question when you can point at the directory that owns a claim before you look for the page that made it. These pages are a lookup, not a sequence.
