...
- It provisions a local Ollama server on the runner (pinned release and SHA-256), pulls a small open model, and runs the ADK trajectory, structured-report, bounded-workflow, and MLflow evaluations against fixed seed data.
