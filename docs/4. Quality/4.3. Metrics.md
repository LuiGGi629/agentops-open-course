...
1. `mise run eval:retrieval` prints keyword vs semantic hit-rate@k for the memory retriever ([3.4. Memory](../3.%20Capabilities/3.4.%20Memory.md); needs local Ollama embeddings).
