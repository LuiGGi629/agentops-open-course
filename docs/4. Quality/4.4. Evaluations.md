...
**Diagram in words:** Local hooks flow into offline CI merge gates. Only after merge does the schedule start Ollama, run model-backed evaluations, and upload evidence.
