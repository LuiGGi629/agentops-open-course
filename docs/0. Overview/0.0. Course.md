...
??? note "Deeper: what the optional GKE lab costs"
    ...
    At the prices checked on 29 July 2026, the always-on fixed estimate is about USD 28 per month with the GKE free-tier credit, or USD 101 without it. Vertex, GCS, and network usage are additional. Spot prices change, so destroy the lab when idle and refresh the estimate before applying.
