...
Everything the platform writes at runtime lives on one [PersistentVolumeClaim (PVC)](../0.%20Overview/0.7.%20Glossary.md#pvc).
...
Continue to [6.7. Promotion and Rollback](./6.7.%20Promotion%20and%20Rollback.md) when you have restored the local state from a backup at least once.
