...
## Install the control plane, not the demo fleet {#how-is-kagent-installed}
...
## Skaffold builds one image and applies one overlay {#what-does-skaffold-deploy}
...
An hour ago you had a Docker daemon and a set of manifests. You now have a cluster whose every piece came from a file you can read, and an agent inside it answering on a port nothing else can reach.
