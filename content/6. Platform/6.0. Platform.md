...
| ------------------------------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Agent` (`agents.kagent.dev`)                     | The BYO agent workload: image, replicas, env, security context, state PVC | [`agent.yaml`](https://github.com/MLOps-Courses/agentops-open-course/blob/main/infra/kagent/agent.yaml) · [6.3. Platform Agents]({{< relref "/6. Platform/6.3. Platform Agents.md" >}})             |
| `ModelConfig` (`modelconfigs.kagent.dev`)         | The OpenAI-compatible model endpoint kagent consumers use                 | [`modelconfig.yaml`](https://github.com/MLOps-Courses/agentops-open-course/blob/main/infra/kagent/modelconfig.yaml) · [6.3. Platform Agents]({{< relref "/6. Platform/6.3. Platform Agents.md" >}}) |
| `RemoteMCPServer` (`remotemcpservers.kagent.dev`) | The governed MCP endpoint (via agentgateway), not the raw service         | [`toolserver.yaml`](https://github.com/MLOps-Courses/agentops-open-course/blob/main/infra/kagent/toolserver.yaml) · [6.4. Platform Tools]({{< relref "/6. Platform/6.4. Platform Tools.md" >}})     |
...
| --------------------------------------------------------------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------- |
| [6.1. Containers]({{< relref "/6. Platform/6.1. Containers.md" >}})               | The non-root agent OCI image                   | `agents/python/Dockerfile`                                                 |
