...
The base deploys Loki and the OTel collector; the `local` overlay adds Prometheus and Alertmanager. Only Grafana and the host Compose profile belong to [Chapter 7]({{< relref "/7. Observability/_index.md" >}}).
