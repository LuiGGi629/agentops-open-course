...
Continue to [0.2. AgentOps]({{< relref "/0. Overview/0.2. AgentOps.md" >}}) when you can say why you would not use an agent for a task whose steps are already known and fixed.
