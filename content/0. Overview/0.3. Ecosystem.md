...
Because traces feed both MLflow and the span-metrics connector, one turn becomes a trace you can open, a set of RED metrics you can alert on, and a stream of logs you can correlate by trace id — from a single OTLP export. [7.2. Monitoring]({{< relref "/7. Observability/7.2. Monitoring.md" >}}) walks that three-pillar correlation end to end.
{{% /collapsible %}}
