...
This course teaches the engineering discipline around an AI agent, not only the model call. You are not expected to recognize the names in the list below yet: each gets its own chapter, and [0.8. Glossary]({{< relref "/0. Overview/0.8. Glossary.md" >}}) defines the course's key terms one line at a time.
...
| 25 min | Observe one grounded turn                               | Use [2.1. First Agent]({{< relref "/2. Agents/2.1. First Agent.md#your-first-turn-and-the-evidence-under-it" >}}) to bind one answer to its `list_incidents` call and returned rows.                                                                                                                                                                       | Live local model observation; wording and latency can vary.                                                           |
