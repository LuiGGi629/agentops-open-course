...
The report helps identify unexercised code, including error branches. No Go coverage threshold is enforced because the owner has not selected one; tests, race detection, formatting, linting, and explicit repository contracts decide pass or fail.
