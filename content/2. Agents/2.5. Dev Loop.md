...
The test task also enforces an 80% line-coverage floor per package, so untested new code fails it instead of quietly moving an average. The percentage it prints stays diagnostic evidence; only the floor is a gate.
