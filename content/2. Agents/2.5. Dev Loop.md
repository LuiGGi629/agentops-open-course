...
Both classes are pinned by `mise run redteam`, which is why the offline gate catches them without a model. The approval flow itself is owned by [4.5. Guardrails]({{< relref "/4. Quality/4.5. Guardrails.md" >}}).
{{% /admonition %}}
