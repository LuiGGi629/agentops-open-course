...
1. Route confirmed issues to a named owner and promote sanitized cases back into the offline set, so `eval:validate` gates their structure and model-backed runs preserve behavioral evidence ([4.4. Evaluations](../4. Quality/4.4. Evaluations.md#how-can-an-evaluation-lie-to-you)).
{{% /collapsible %}}
