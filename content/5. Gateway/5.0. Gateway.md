...
Chapter 5.5 owns the caller-auth details ([5.5. Gateway Security]({{< relref "/5. Gateway/5.5. Gateway Security.md#how-do-callers-authenticate-to-the-gateway" >}})); Chapter 5.6 explains why the host profile leaves gateway OTLP off ([5.6. Gateway Observability]({{< relref "/5. Gateway/5.6. Gateway Observability.md#why-does-the-host-gateway-expose-metrics-but-not-traces" >}})).
{{% /collapsible %}}
