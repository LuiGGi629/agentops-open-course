...
{{< include path="infra/agentgateway/host/config.yaml" region="host-mcp-bind" lang="yaml" >}}
...
1. A2A protocol-aware forwarding — [5.3. A2A Gateway]({{< relref "/5. Gateway/5.3. A2A Gateway.md#why-use-a2a-policy-instead-of-generic-http-proxying" >}}).
...
Chapter 4.5 owns all three ([4.5. Guardrails]({{< relref "/4. Quality/4.5. Guardrails.md#how-are-action-arguments-validated" >}})); this page only draws the line.
