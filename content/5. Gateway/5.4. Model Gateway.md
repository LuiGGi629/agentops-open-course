...
## Two places name a model; only one of them wins {#what-is-the-application-contract}
...
## What "OpenAI-compatible" standardizes, and what it does not {#how-is-local-qwen3-configured}
...
An hour ago swapping models meant editing the agent. You now know that behind a model listener it means editing the gateway — and that a request naming the wrong model does not fail loudly at the boundary, it quietly becomes a different request.
