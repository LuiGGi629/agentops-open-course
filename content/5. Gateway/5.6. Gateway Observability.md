...
Rate, tail latency, and policy rejections. Those are PromQL expressions, the query language Prometheus reads; [7.2. Monitoring]({{< relref "/7. Observability/7.2. Monitoring.md" >}}) is where you build panels on them.
{{% /collapsible %}}
