...
Those three families are the ones the course's Grafana dashboard pins in [`infra/observability/grafana/dashboards/agentops.json`](https://github.com/MLOps-Courses/agentops-open-course-go/blob/main/infra/observability/grafana/dashboards/agentops.json):
