...
[5.5. Gateway Security]({{< relref "/5. Gateway/5.5. Gateway Security.md" >}}) revisits this as a deployment choice: screening at the gateway covers every client at once, while screening in a callback covers only this agent.
{{% /collapsible %}}
