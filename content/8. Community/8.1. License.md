...
## Why four subtrees carry byte-identical copies of the licence

Someone who copies `agents/` receives a directory, not a repository, so the grant has to be inside it. Four distributable subtrees carry their own copy, and the copies are not allowed to diverge:
