...
## What the two jobs actually do {#what-does-the-release-workflow-publish}
...
An hour ago a version was a label someone typed. You can now trace one from `VERSION` to a signed digest, and say at which step the tag stops being able to move.
