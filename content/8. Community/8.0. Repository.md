...
└── infra/               # ← THE INFRASTRUCTURE: agentgateway, k8s, kagent, OTel/Tempo/Loki, OpenTofu (MIT)
```
...
| `observability/`                          | the host Compose stack: Tempo, Loki, OTel, Prometheus, Alertmanager, Grafana  | [7. Observability]({{< relref "/7. Observability/_index.md" >}}) |
