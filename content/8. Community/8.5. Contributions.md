...
An hour ago "tests pass" was a sentence you had to trust. You can now say which of three runs produced it, reproduce the red from one file edit, and write the two lines of a pull request that let a reviewer skip trusting you entirely.
