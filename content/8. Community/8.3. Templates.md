...
Copy the `.github/` forms above into your own repository and go to [8.7. Capstone]({{< relref "/8. Community/8.7. Capstone.md" >}}). Everything below is for the generator path.
{{% /admonition %}}
