...
An hour ago "let's make it a template" sounded like a free multiplier. You can now price it in files — the eleven one name touches here — and say out loud which cells a generator is allowed to rewrite.
