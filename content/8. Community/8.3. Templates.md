...
- **Time:** about 13 minutes, concept. {{% /admonition %}}
...
The reusable idea is not the wording but the _shape_: force structure at intake, label for automatic routing, make required fields carry the information a reviewer would otherwise chase, and close the unstructured escape hatch. What a contributor actually does with these forms is [8.5. Contributions]({{< relref "/8. Community/8.5. Contributions.md" >}}).
...
1. **Fork once.** Start from the completed reference on `main`, branch, and change one boundary at a time while the gates stay green. This is exactly the path [8.7. Capstone]({{< relref "/8. Community/8.7. Capstone.md" >}}) endorses and grades. You keep the git history, the tests, and the infrastructure, and you pay no **generator tax**: the versions, migrations, and support a template owes every project it stamps out.
...
{{% admonition tip "Forking? You are done with this page" %}}

Copy the `.github/` forms above into your own repository and go to [8.7. Capstone]({{< relref "/8. Community/8.7. Capstone.md" >}}). Everything below is for the generator path. {{% /admonition %}}
...
1. Deployment coordinates: the OCI image name, Kubernetes namespace, local registry, and the optional GCP project/region/zone.
...
1. The GKE overlay mounts no cloud key at all. It uses **Workload Identity Federation** (WIF), a Kubernetes identity exchanged for a Google one, through `iam.gke.io/gcp-service-account` annotations ([0.7. Glossary]({{< relref "/0. Overview/0.7. Glossary.md#wif" >}})).
...
{{% collapsible note "Deeper: where each parameter lives today" %}}
...
| WIF identity + cluster DNS address   | GKE overlay placeholders resolved by `infra/scripts/render-gke.sh` from OpenTofu outputs                                                                                                     |
| {{% /collapsible %}}                 |                                                                                                                                                                                              |
...
1. the one `mise run` task vocabulary that hooks, CI, and this course all reuse — see [8.5. Contributions]({{< relref "/8. Community/8.5. Contributions.md" >}}) and [8.4. Documentation]({{< relref "/8. Community/8.4. Documentation.md" >}});
...
{{% collapsible note "Deeper: the full validation loop" %}}
...
- [8.5. Contributions]({{< relref "/8. Community/8.5. Contributions.md" >}}) — the workflow that fills the forms in.
- [8.7. Capstone]({{< relref "/8. Community/8.7. Capstone.md" >}}) — the recommended way to build your own agent from this one.
- [8.4. Documentation]({{< relref "/8. Community/8.4. Documentation.md" >}}) — the docs contract those templates protect.
...
Return to [8. Community]({{< relref "/8. Community/_index.md" >}}) and pick your next maintenance question when you have decided, in one sentence, whether you are forking this repository once or maintaining a generator.
