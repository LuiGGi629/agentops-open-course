...
The hostname is stable enough that the docs linter (`scripts/check_conventions.py`) rejects any earlier spelling of it, so every page states it as `registry.localhost:5050` and never drifts. {{% /collapsible %}}
