...
Pair the base doctor with offline `mise run check:core` at this page's checkpoint. [1.5. Workspace](./1.5.%20Workspace.md) owns that learner gate and how it differs from the full maintainer gate.
