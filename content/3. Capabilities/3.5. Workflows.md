...
The structural test owns the exact four-node author order. The live artifact deliberately excludes raw events and model content; it proves three behavior samples cleared the reviewed floor without weakening that privacy boundary.
